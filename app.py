    ...
    if active_tab == "tab-1":
        ...
        return html.Div([
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    html.Div([
                        dcc.DatePickerInput(id="date_input_tab1_start", date=t1_s, display_format="YYYY-MM-DD", style={"width": "47%"}),
                        html.Span(" ~ ", style={"padding": "0 5px"}),
                        dcc.DatePickerInput(id="date_input_tab1_end", date=t1_e, display_format="YYYY-MM-DD", style={"width": "47%"})
        ...
        return html.Div([
            dbc.Row([
                ...
                dbc.Col([
                    html.Label("📅 분석 기간:", className="font-weight-bold text-secondary", style={"fontSize": "13px"}),
                    html.Div([
                        dcc.DatePickerInput(id="date_input_tab2_start", date=t2_s, display_format="YYYY-MM-DD", style={"width": "47%"}),
                        html.Span(" ~ ", style={"padding": "0 5px"}),
                        dcc.DatePickerInput(id="date_input_tab2_end", date=t2_e, display_format="YYYY-MM-DD", style={"width": "47%"})
                    ], style={"display": "flex", "alignItems": "center"})
                ], xs=12, md=6)
            ], className="g-2 mb-3"),
            chart_node
        ...
        return html.Div([
            dbc.Row([
                ...
                dbc.Col([
                    html.Label("📅 분석 기간:", className="font-weight-bold text-secondary", style={"fontSize": "13px"}),
                    html.Div([
                        dcc.DatePickerInput(id="date_input_tab3_start", date=t3_s, display_format="YYYY-MM-DD", style={"width": "47%"}),
                        html.Span(" ~ ", style={"padding": "0 5px"}),
                        dcc.DatePickerInput(id="date_input_tab3_end", date=t3_e, display_format="YYYY-MM-DD", style={"width": "47%"})
                    ], style={"display": "flex", "alignItems": "center"})
                ], xs=12, md=6)
            ], className="g-2 mb-3"),
            chart_node
        ...
        return html.Div([
            dbc.Row([
                ...
                dbc.Col([                    html.Label("📅 분석 기간:", className="font-weight-bold text-secondary", style={"fontSize": "13px"}),
                    html.Div([
        ...
        return html.Div([
            dbc.Row([
                ...
                dbc.Col([
                    html.Label("📅 분석 기간:", className="font-weight-bold text-secondary", style={"fontSize": "13px"}),
                    html.Div([
                        dcc.DatePickerInput(id="date_input_tab5_start", date=t5_s, display_format="YYYY-MM-DD", style={"width": "47%"}),
                        html.Span(" ~ ", style={"padding": "0 5px"}),
                        dcc.DatePickerInput(id="date_input_tab5_end", date=t5_e, display_format="YYYY-MM-DD", style={"width": "47%"})
                    ], style={"display": "flex", "alignItems": "center"})
                ], xs=12, md=6)
            ], className="g-2 mb-3"),
